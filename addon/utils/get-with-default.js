...
const addonDefaults = {
  ...
  fieldSettings: { // TODO document that these can all be included in a form in "fieldDefaults"
    ...
    alwaysValidateOn: ['focusOut', 'onUserInteraction','change', 'submit'], // Array of strings, possible values include focusOut, keyUp, onChange // TODO check onChange as validation event
    eventLog: [],
  ...
  fieldTypes: [
    ...
    },
    {
      ...
      clonable: true, // TODO is this necessary?
